...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) { // verifica se o campo nome esta vaizio se estiver lança a msg
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) { // verifica se o campo nome esta vaizio se estiver lança a msg
